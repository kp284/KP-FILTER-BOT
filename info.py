...
# Bot information
SESSION = environ.get('SESSION', 'KPBot')
API_ID = int(environ.get('API_ID', '20219406'))
API_HASH = environ.get('API_HASH', 'e9e99cb12d4bec9de430f30f7b0bc33d')
...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7507183871').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1003006141242'))
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002831591310') # give your force subscribe channel id here else leave it blank
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '7507183871')
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://pkrishrameshbhai284:mNxYeiz6Jp7g59TY@cluster0.lkpavia.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
DATABASE_NAME = environ.get('DATABASE_NAME', "pkrishrameshbhai284")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'pkrishrameshbhai284')
...
CLONE_DATABASE_URI = environ.get('CLONE_DATABASE_URI', "mongodb+srv://pkrishrameshbhai284:ItViwquF5LTwfRBf@cluster0.fy1d9pa.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0") # Necessary If clone mode is true
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/KP_BOTS')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/kpbotmaker')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'KP_BOTS') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/patelkrish_99')
